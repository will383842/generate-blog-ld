...
{
    /**
     * Supprime les colonnes de traduction de ulixai_services
     * 
     * Ces colonnes ne doivent PAS être dans la table principale car
     * le modèle UlixaiService utilise HasTranslations et une table
     * ulixai_service_translations séparée.
     * 
     * ARCHITECTURE CORRECTE:
     * - name_fr et name_en dans ulixai_services (table principale)
     * - Autres langues dans ulixai_service_translations
     */
