...
export default function UlixaiDashboard() {
  useTranslation();
  ...
  const { data: gapsData } = useCoverageGaps('ulixai');
  ...
  const evolutionData = useMemo(() => {
    return apiEvolution.map((e) => ({
      date: e.date,
      articles: e.articles,
      prestataires: Math.floor(e.articles * 0.7),
    }));
  }, [apiEvolution]);
  ...
  const handleCountryClick = useCallback((country: CountryCoverage) => {
    ...
    setCountryDetailsData({
      ...
      publishedArticles: Math.floor(country.articles * 0.82),
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ulixai</h1>
            <p className="text-sm text-muted-foreground">
              Marketplace de services pour expatriés
            </p>
          </div>
        </div>
        <Button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button size="sm" className="bg-purple-600 hover:bg-purple-700" onClick={handleGenerateAllGaps}>
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      ~{gap.traffic.toLocaleString()} recherches
                    </p>
                  </div>
                </div>
              ))}
        ...
        <Card>
          ...
          <CardContent>
            <LineChart
              data={evolutionData}
              series={[
                { dataKey: 'articles', name: 'Pages Services', color: '#8B5CF6' },
                { dataKey: 'prestataires', name: 'Fiches Prestataires', color: '#10B981' },
              ]}
              xAxisKey="date"
              height={280}
