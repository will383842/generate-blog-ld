...
class ProcessProgramBatch implements ShouldQueue
{
    ...
    {
        Log::info("ProcessProgramBatch: Starting", [
        ...
        try {
            ...
            Log::info("ProcessProgramBatch: Completed", [
                'program_id' => $this->program->id,
                'run_id' => $this->run->id,
            ...
            Log::error("ProcessProgramBatch: Failed", [
                'program_id' => $this->program->id,
                'run_id' => $this->run->id,
                'error' => $e->getMessage(),
            ]);
    ...
    {
        Log::error("ProcessProgramBatch: Job failed", [
            'program_id' => $this->program->id,
            'run_id' => $this->run->id,
