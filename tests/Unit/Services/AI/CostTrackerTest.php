...
class CostTracker
{
    ...
    // =========================================================================
    // OBTENIR LES COÛTS (depuis BDD via ApiCost)
    // =========================================================================
    ...
    {
        // D'abord vérifier le cache pour performance
        ...
        // Sinon, lire depuis la BDD via ApiCost
    ...
    public function checkAlerts(): void
    {
        ...
        // Vérifier chaque seuil (du plus élevé au plus bas)
...
MESSAGE;
    ...
    public function getStatistics(): array
    {
        return [
            ...
            'by_service' => ApiCost::getCostByService('today'),
            'today_stats' => ApiCost::getStats('today'),
            'trend_7_days' => ApiCost::getDailyTrend(7),
            'top_operations' => ApiCost::getTopOperations(5, 'today'),
            'projection' => ApiCost::getMonthlyProjection(),
        ];
    }
    ...
    {
        return ApiCost::getCostByService('today');
    }
    ...
    {
        $projection = ApiCost::getMonthlyProjection();
        $projection['budget'] = $this->monthlyBudget;
        $projection['projected_percent'] = $this->monthlyBudget > 0 
            ? round(($projection['projected_cost'] / $this->monthlyBudget) * 100, 2)
            : 0;
